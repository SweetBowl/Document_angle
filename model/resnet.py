...
class ResNet_3(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, more_fc=False, simplfied=False):
        ...
        if simplfied:
            ...
            n = 512
        if more_fc:
            self.fc1 = nn.Linear(n * block.expansion, n * block.expansion)
            self.fc2 = nn.Linear(n * block.expansion, n * block.expansion)
            self.fc3 = nn.Linear(n * block.expansion, num_classes)
        else:
            self.fc = nn.Linear(n * block.expansion, num_classes)
...
def resnet18(pretrained=False, **kwargs):
    ...
    """
    model = ResNet_3(BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
...
def resnet34(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_3(BasicBlock, [3, 4, 6, 3], **kwargs)
    if pretrained:
...
def resnet50(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_3(Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
...
def resnet101(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_3(Bottleneck, [3, 4, 23, 3], **kwargs)
    if pretrained:
...
def resnet152(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_3(Bottleneck, [3, 8, 36, 3], **kwargs)
    if pretrained:
